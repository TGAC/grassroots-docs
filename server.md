...
For a Service to be paired, it needs to be written with this in mind. An example is the [Blast Service](@ref blast_services) for searching genetic sequences. See this example and the developer guide for more details.
